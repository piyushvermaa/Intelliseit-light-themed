        ...
        <div className="flex">
          <form onSubmit={handleSubmit} className="w-full">
            ...
            <div className="flex flex-col space-y-5">
              ...
              <button
                type="submit"
                className="w-full py-3 px-2 font-medium text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg border-indigo-500 hover:shadow inline-flex space-x-2 items-center justify-center"
              >
                <span>Signup</span>
              </button>
